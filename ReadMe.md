...
- [Gradle插件开发](https://blog.csdn.net/itachi85/article/details/89038309)
- [Dev Custom Gradle Plugins](https://docs.gradle.org/current/userguide/custom_plugins.html#sec:working_with_files_in_custom_tasks_and_plugins)
- [Gradle Tutorials and Guides](https://gradle.org/guides/)
- [Maven Publish Plugin](https://docs.gradle.org/current/userguide/publishing_maven.html#publishing_maven:install)
- [Gradle Project Reference](https://docs.gradle.org/current/dsl/org.gradle.api.Project.html)
- [Gradle修改Manifest文件](https://www.jianshu.com/p/f5cd48019109)
